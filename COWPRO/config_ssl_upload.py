...
def cfg():
    ...
    which_aug = 'aug_v3' #'sabs_aug' # standard data augmentation with intensity and geometric transforms
    input_size = (256, 256)
    ...
    clsname = 'grid_proto' # 
    resume = False
    reload_model_path = './runs/mySSL__CHAOST2_Superpix_sets_0_1shot/314_best_ref/snapshots/100000.pth' # path for reloading a trained model (overrides ms-coco initialization)
    ...
    tversky_params = {'tversky_alpha' : 0.7,
                    'tversky_beta' : 0.3}

    lambda_loss = {'loss1':1.0, 'loss2':1.0, 'loss3':2.0, 'loss4':40, 'loss5': 1.0}
    ...
    path = {
        'log_dir': './runs',
        'SABS':{'data_dir': "/media/cvpr/4231E076490AAA38/Aditya/datasets/SABS/Abdomen/RawData/Training/sabs_CT_normalized"
            },
        'C0':{'data_dir': "feed your dataset path here"
            },
        'CHAOST2':{'data_dir': "/media/cvpr/4231E076490AAA38/Aditya/datasets/CHAOS/CHAOS_Train_Sets/Train_Sets/chaos_MR_T2_normalized/"
            },
        'SABS_Superpix':{'data_dir': "/media/cvpr/4231E076490AAA38/Aditya/datasets/SABS/Abdomen/RawData/Training/sabs_CT_normalized"},
        'C0_Superpix':{'data_dir': "feed your dataset path here"},
        'CHAOST2_Superpix':{'data_dir': "/media/cvpr/4231E076490AAA38/Aditya/datasets/CHAOS/CHAOS_Train_Sets/Train_Sets/chaos_MR_T2_normalized/"},
        }

    DATASET_CONFIG = {'SABS':{'img_bname': f'/media/cvpr/4231E076490AAA38/Aditya/datasets/SABS/Cervix/RawData/Training/sabs_CT_normalized/image_*.nii.gz',
