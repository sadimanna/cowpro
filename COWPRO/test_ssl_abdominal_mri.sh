...
ALL_EV=( 2) # 1 2 3 4) # 5-fold cross validation (0, 1, 2, 3, 4)
ALL_SCALE=( "MIDDLE") # config of pseudolabels

### Use L/R kidney as testing classes
LABEL_SETS=0 
EXCLU='[2,3]' 
# setting 2: excluding kidneies in training set to test generalization capability even though they are unlabeled. 
# Use [] for setting 1 by Roy et al.
...
do
    ...
    RELOAD_PATH="./exps/myexperiments_MIDDLE_0/mySSL_train_CHAOST2_Superpix_lbgroup0_scale_MIDDLE_vfold${EVAL_FOLD}_CHAOST2_Superpix_sets_0_1shot/17/snapshots/50000.pth"
    # RELOAD_PATH='./runs/mySSL__CHAOST2_Superpix_sets_0_1shot/314_best_ref/snapshots/100000.pth'

    python3 validationv3.py with \
