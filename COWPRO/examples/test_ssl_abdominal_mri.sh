...
do
    ...
    RELOAD_PATH='/media/cvpr/4231E076490AAA38/Aditya/agun-sona-master/runs/mySSL__CHAOST2_Superpix_sets_0_1shot/479/snapshots/25000.pth' #'please feed the path to the trained weights here' # path to the reloaded model

    python3 validation2.py with \
